...
namespace prjEnrollifyCS
{
    public partial class frmRequest : Form
    {
        ...
        {
            string selectedCourse = lstCourses.Items[lstCourses.SelectedIndex].ToString();
            MessageBox.Show(selectedCourse + " has been requested!", "Course Requested", MessageBoxButtons.OK, MessageBoxIcon.Information);
